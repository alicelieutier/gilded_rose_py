...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_typical(self):
        ...
        self.assertDecayOverNDays(gilded_rose, gilded_rose.items[0], expected_decay)
    ...
    def test_backstage_passes_max_quality(self):
        ...
        gilded_rose = GildedRose(items)
        self.assertDecayOverNDays(gilded_rose, gilded_rose.items[0], [(14, 50)])
        items = [Item("Backstage passes to a TAFKAL80ETC concert", 10, 49)]
        gilded_rose = GildedRose(items)
        self.assertDecayOverNDays(gilded_rose, gilded_rose.items[0], [(9, 50)])
        items = [Item("Backstage passes to a TAFKAL80ETC concert", 5, 49)]
        gilded_rose = GildedRose(items)
        self.assertDecayOverNDays(gilded_rose, gilded_rose.items[0], [(4, 50)])
